"""
Django settings for demo_38836 project.
...
WSGI_APPLICATION = 'demo_38836.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_38836 API",
    "DESCRIPTION": "API documentation for demo_38836 App",
    "VERSION": "v1",
}
